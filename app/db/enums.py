...
DYNAMIC_RISK_EVENTS = [
    {"name": "FOMC Meeting", "type": "macro", "impact": "High",
     "recurrence": "6_weeks", "typical_vol_multiplier": 1.8,
     "regime_survival_impact": -15},
    {"name": "CPI Release", "type": "macro", "impact": "High",
     "recurrence": "monthly", "typical_vol_multiplier": 1.6,
     "regime_survival_impact": -12},
    {"name": "Options Expiry", "type": "market", "impact": "Medium",
     "recurrence": "monthly", "typical_vol_multiplier": 1.3,
     "regime_survival_impact": -8},
    {"name": "ETF Flow Report", "type": "market", "impact": "Medium",
     "recurrence": "weekly", "typical_vol_multiplier": 1.1,
     "regime_survival_impact": -5},
    {"name": "PCE Inflation", "type": "macro", "impact": "High",
     "recurrence": "monthly", "typical_vol_multiplier": 1.5,
     "regime_survival_impact": -10},
    {"name": "Fed Minutes", "type": "macro", "impact": "Medium",
     "recurrence": "6_weeks", "typical_vol_multiplier": 1.3,
     "regime_survival_impact": -8},
    {"name": "Jobs Report (NFP)", "type": "macro", "impact": "High",
     "recurrence": "monthly", "typical_vol_multiplier": 1.5,
     "regime_survival_impact": -12},
    {"name": "Quarterly GDP", "type": "macro", "impact": "Medium",
     "recurrence": "quarterly", "typical_vol_multiplier": 1.2,
